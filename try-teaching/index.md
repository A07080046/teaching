...
![文本, 信件 描述已自动生成](./media/image39.png)

### 活动：

![文本, 信件
描述已自动生成](./media/image40.png)
...
![文本, 信件
描述已自动生成](./media/image44.png)

直接导入课文法：

![文本, 信件 描述已自动生成](./media/image45.png)
...
![卡通人物 中度可信度描述已自动生成](./media/image51.png)

![卡通人物
低可信度描述已自动生成](./media/image52.png)
...
![图片包含 图示
描述已自动生成](./media/image54.png)

![图片包含 文本
描述已自动生成](./media/image55.png)
...
![社交网站的手机截图
低可信度描述已自动生成](./media/image56.jpeg)
...
![文本, 信件
描述已自动生成](./media/image58.png)

接龙夸夸自己（换主语）

### 活动：

![文本, 信件 描述已自动生成](./media/image59.png)
...
![图片包含 日历
描述已自动生成](./media/image66.png)

### 讲解：

![文本, 信件
描述已自动生成](./media/image67.png)
...
![文本, 信件
描述已自动生成](./media/image68.png)

### 讲解2：

![图示
中度可信度描述已自动生成](./media/image69.png)
...
![表格 描述已自动生成](./media/image70.png)

### 操练3：

看词说话，早上我起床以后......（一人说三句）

![表格 描述已自动生成](./media/image71.png)
...
![文本
中度可信度描述已自动生成](./media/image83.png)
...
![文本, 信件
中度可信度描述已自动生成](./media/image88.png)

修改句子：

![文本, 信件
描述已自动生成](./media/image89.png)
...
![文本, 信件 描述已自动生成](./media/image93.png)

改写句子。

![文本, 信件
描述已自动生成](./media/image94.png)

### 活动：

![文本 描述已自动生成](./media/image95.png)
